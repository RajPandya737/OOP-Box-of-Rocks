...
//Purpose: create a deck to hold the cards
package com.example.pandyarajbor;

public class Stack {
    //Count int to tell how many cards left in the stack
    private int count;
    //Deck object that holds the cards
    private Object Deck[] = new Object[78];
    ...
    public boolean isFull() {
        //returns a boolean. Returns true if the deck is full
        return (count == 78);
    }
    ...
    public boolean isEmpty() {
        //returns true if there are no cards in the deck (empty)
        return count == 0;
    }
    ...
    public void shuffle() {
        //shuffles the cards in random order before putting them all into a single stack of object
        String questions[] = {"In the 1990s, how many of TIME magazine's Man of the year covers featured two or more people",
                ...
                "What numbers is shown on the green alot of a roulette wheel?",
                ...
                "According to the an Oxford Deckbase, how many of the 10 most used words in English have four letters?",
        ...
        String reasons[] = {"In 1996, impeached POTUS Bill Clinton and his accuser Xen Starr; in 1993 it was peacemakers de Klerk, Mandela, Rabin, and Arafat.",
                ...
                "During the game, players may play land from their hands in order to generate mans for spells, creatures, and artifacts.",
        ...
        for (int i = 0; i < 100; i++) {
            ...
            ans[r2] = temp1;
            //swap reason array
            String temp2 = reasons[r1];
            reasons[r1] = reasons[r2];
            reasons[r2] = temp2;
        }
        count = 0;
//push all (now in random order) into the Deck
        for (int i = 0; i < questions.length; i++) {
            Card c = new Card(questions[i], ans[i], reasons[i]);
            push(c);
        }
    }
}
